    ...
    <main className="flex flex-1 flex-col items-center gap-10 text-black">
      <div className="flex flex-col rounded-xl gap-6 px-5 md:px-10">
        ...
        <div className="flex flex-col w-full items-start justify-center p-2">
          ...
          <Typography variant="lead" className="flex items-center mt-2">
            <span className="material-symbols-outlined mr-3">email</span>
            info@ramen-app.com
          </Typography>
          <div className="flex gap-6 text-blue-gray-900 mt-4">
            <Typography
              as="a"
              href="#"
        ...
        <div className="rounded-xl w-full h-96 sm:h-[500px] overflow-hidden">
          <iframe
