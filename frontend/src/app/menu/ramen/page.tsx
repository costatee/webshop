...
export default function RamenMenu(): JSX.Element {
  return (
    <main className="flex min-h-screen flex-col items-center gap-10 px-20">
      ...
      <div className="flex flex-col w-full max-w-7xl rounded-xl bg-[#FAFAFA] items-center justify-center pb-6 px-10">
        <p className="relative w-full text-center text-[2rem] mt-8">Ramen dishes</p>
        <p className="relative w-full text-center font-light text-sm mb-8">Warms up body and soul</p>
